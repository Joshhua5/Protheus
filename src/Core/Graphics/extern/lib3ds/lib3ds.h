...
extern Lib3dsFile* lib3ds_file_open(const char *filename); 
extern int lib3ds_file_save(Lib3dsFile *file, const char *filename);
extern Lib3dsFile* lib3ds_file_new();
extern void lib3ds_file_free(Lib3dsFile *file);
extern void lib3ds_file_eval(Lib3dsFile *file, float t);
extern int lib3ds_file_read(Lib3dsFile *file, Lib3dsIo *io);
extern int lib3ds_file_write(Lib3dsFile *file, Lib3dsIo *io);
extern void lib3ds_file_reserve_materials(Lib3dsFile *file, int size, int force);
extern void lib3ds_file_insert_material(Lib3dsFile *file, Lib3dsMaterial *material, int index);
extern void lib3ds_file_remove_material(Lib3dsFile *file, int index);
extern int lib3ds_file_material_by_name(Lib3dsFile *file, const char *name);
extern void lib3ds_file_reserve_cameras(Lib3dsFile *file, int size, int force);
extern void lib3ds_file_insert_camera(Lib3dsFile *file, Lib3dsCamera *camera, int index);
extern void lib3ds_file_remove_camera(Lib3dsFile *file, int index);
extern int lib3ds_file_camera_by_name(Lib3dsFile *file, const char *name);
extern void lib3ds_file_reserve_lights(Lib3dsFile *file, int size, int force);
extern void lib3ds_file_insert_light(Lib3dsFile *file, Lib3dsLight *light, int index);
extern void lib3ds_file_remove_light(Lib3dsFile *file, int index);
extern int lib3ds_file_light_by_name(Lib3dsFile *file, const char *name);
extern void lib3ds_file_reserve_meshes(Lib3dsFile *file, int size, int force);
extern void lib3ds_file_insert_mesh(Lib3dsFile *file, Lib3dsMesh *mesh, int index);
extern void lib3ds_file_remove_mesh(Lib3dsFile *file, int index);
extern int lib3ds_file_mesh_by_name(Lib3dsFile *file, const char *name);
extern Lib3dsMesh* lib3ds_file_mesh_for_node(Lib3dsFile *file, Lib3dsNode *node);
extern Lib3dsNode* lib3ds_file_node_by_name(Lib3dsFile *file, const char* name, Lib3dsNodeType type);
extern Lib3dsNode* lib3ds_file_node_by_id(Lib3dsFile *file, unsigned short node_id);
extern void lib3ds_file_append_node(Lib3dsFile *file, Lib3dsNode *node, Lib3dsNode *parent);
extern void lib3ds_file_insert_node(Lib3dsFile *file, Lib3dsNode *node, Lib3dsNode *at);
extern void lib3ds_file_remove_node(Lib3dsFile *file, Lib3dsNode *node);
extern void lib3ds_file_minmax_node_id(Lib3dsFile *file, unsigned short *min_id, unsigned short *max_id);
extern void lib3ds_file_create_nodes_for_meshes(Lib3dsFile *file);
 ...
 */
extern  void lib3ds_file_bounding_box_of_objects(
    Lib3dsFile *file, 
    int include_meshes, 
    int include_cameras,
    int include_lights,
 ...
 */
extern  void lib3ds_file_bounding_box_of_nodes(
    Lib3dsFile *file, 
    int include_meshes, 
    int include_cameras, 
    int include_lights, 
...
extern Lib3dsMaterial* lib3ds_material_new(const char *name);
extern void lib3ds_material_free(Lib3dsMaterial *material);
extern Lib3dsCamera* lib3ds_camera_new(const char *name);
extern void lib3ds_camera_free(Lib3dsCamera *mesh);
extern Lib3dsLight* lib3ds_light_new(const char *name);
extern void lib3ds_light_free(Lib3dsLight *mesh);
extern Lib3dsMesh* lib3ds_mesh_new(const char *name);
extern void lib3ds_mesh_free(Lib3dsMesh *mesh);
extern void lib3ds_mesh_resize_vertices(Lib3dsMesh *mesh, int nvertices, int use_texcos, int use_flags);
extern void lib3ds_mesh_resize_faces(Lib3dsMesh *mesh, int nfaces);
extern void lib3ds_mesh_bounding_box(Lib3dsMesh *mesh, float bmin[3], float bmax[3]);
extern void lib3ds_mesh_calculate_face_normals(Lib3dsMesh *mesh, float (*face_normals)[3]);
extern void lib3ds_mesh_calculate_vertex_normals(Lib3dsMesh *mesh, float (*normals)[3]);

extern Lib3dsNode* lib3ds_node_new(Lib3dsNodeType type);
extern Lib3dsAmbientColorNode* lib3ds_node_new_ambient_color(float color0[3]);
extern Lib3dsMeshInstanceNode* lib3ds_node_new_mesh_instance(Lib3dsMesh *mesh, const char* instance_name, float pos0[3], float scl0[3], float rot0[4]);
extern Lib3dsCameraNode* lib3ds_node_new_camera(Lib3dsCamera *camera);
extern Lib3dsTargetNode* lib3ds_node_new_camera_target(Lib3dsCamera *camera);
extern Lib3dsOmnilightNode* lib3ds_node_new_omnilight(Lib3dsLight *light);
extern Lib3dsSpotlightNode* lib3ds_node_new_spotlight(Lib3dsLight *light);
extern Lib3dsTargetNode* lib3ds_node_new_spotlight_target(Lib3dsLight *light);
extern void lib3ds_node_free(Lib3dsNode *node);
extern void lib3ds_node_eval(Lib3dsNode *node, float t);
extern Lib3dsNode* lib3ds_node_by_name(Lib3dsNode *node, const char* name, Lib3dsNodeType type);
extern Lib3dsNode* lib3ds_node_by_id(Lib3dsNode *node, unsigned short node_id);

extern Lib3dsTrack* lib3ds_track_new(Lib3dsTrackType type, int nkeys);
extern void lib3ds_track_free(Lib3dsTrack *track);
extern void lib3ds_track_resize(Lib3dsTrack *track, int nkeys);
extern void lib3ds_track_eval_bool(Lib3dsTrack *track, int *b, float t);
extern void lib3ds_track_eval_float(Lib3dsTrack *track, float *f, float t);
extern void lib3ds_track_eval_vector(Lib3dsTrack *track, float v[3], float t);
extern void lib3ds_track_eval_quat(Lib3dsTrack *track, float q[4], float t);
...
*/
extern  void lib3ds_math_cubic_interp(
    float *v, 
    float *a,
    float *p,
    float *q,
...
extern  void lib3ds_vector_make(
    float c[3],
    float x,
    float y,
    float z);
...
*/
extern  void lib3ds_vector_zero(
    float c[3]);
...
*/
extern  void lib3ds_vector_copy( 
    float dst[3],  
    float src[3]);
...
/** 
    ...
    \param c
        The Pointer to the vector.
*/
extern  void lib3ds_vector_neg(
    float c[3]);

extern  void lib3ds_vector_make(float c[3], float x, float y, float z);
extern  void lib3ds_vector_zero(float c[3]);
extern  void lib3ds_vector_add(float c[3], float a[3], float b[3]);
extern  void lib3ds_vector_sub(float c[3], float a[3], float b[3]);
extern  void lib3ds_vector_scalar_mul(float c[3], float a[3], float k);
extern  void lib3ds_vector_cross(float c[3], float a[3], float b[3]);
extern  float lib3ds_vector_dot(float a[3], float b[3]);
extern  float lib3ds_vector_length(float c[3]);
extern  void lib3ds_vector_normalize(float c[3]);
extern  void lib3ds_vector_normal(float n[3], float a[3], float b[3], float c[3]);
extern  void lib3ds_vector_min(float c[3], float a[3]);
extern  void lib3ds_vector_max(float c[3], float a[3]);
extern  void lib3ds_vector_transform(float c[3], float m[4][4], float a[3]);

extern  void lib3ds_quat_identity(float c[4]);
extern  void lib3ds_quat_copy(float dest[4], float src[4]);
extern  void lib3ds_quat_axis_angle(float c[4], float axis[3], float angle);
extern  void lib3ds_quat_neg(float c[4]);
extern  void lib3ds_quat_cnj(float c[4]);
extern  void lib3ds_quat_mul(float c[4], float a[4], float b[4]);
extern  void lib3ds_quat_scalar(float c[4], float k);
extern  void lib3ds_quat_normalize(float c[4]);
extern  void lib3ds_quat_inv(float c[4]);
extern  float lib3ds_quat_dot(float a[4], float b[4]);
extern  float lib3ds_quat_norm(float c[4]);
extern  void lib3ds_quat_ln(float c[4]);
extern  void lib3ds_quat_ln_dif(float c[4], float a[4], float b[4]);
extern  void lib3ds_quat_exp(float c[4]);
extern  void lib3ds_quat_slerp(float c[4], float a[4], float b[4], float t);
extern  void lib3ds_quat_squad(float c[4], float a[4], float p[4], float q[4], float b[4], float t);
extern  void lib3ds_quat_tangent(float c[4], float p[4], float q[4], float n[4]);

extern  void lib3ds_matrix_zero(float m[4][4]);
extern  void lib3ds_matrix_identity(float  m[4][4]);
extern  void lib3ds_matrix_copy(float dest[4][4], float src[4][4]);
extern  void lib3ds_matrix_neg(float m[4][4]);
extern  void lib3ds_matrix_transpose(float m[4][4]);
extern  void lib3ds_matrix_add(float m[4][4], float a[4][4], float b[4][4]);
extern  void lib3ds_matrix_sub(float m[4][4], float a[4][4], float b[4][4]);
extern  void lib3ds_matrix_mult(float m[4][4], float a[4][4], float b[4][4]);
extern  void lib3ds_matrix_scalar(float m[4][4], float k);
extern  float lib3ds_matrix_det(float m[4][4]);
extern  int lib3ds_matrix_inv(float m[4][4]);
extern  void lib3ds_matrix_translate(float m[4][4], float x, float y, float z);
extern  void lib3ds_matrix_scale(float m[4][4], float x, float y, float z);
extern  void lib3ds_matrix_rotate_quat(float m[4][4], float q[4]);
extern  void lib3ds_matrix_rotate(float m[4][4], float angle, float ax, float ay, float az);
extern  void lib3ds_matrix_camera(float m[4][4], float pos[3], float tgt[3], float roll);
